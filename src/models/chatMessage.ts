...
export class ChatModel {
    ...
    // Добавить новое сообщение, возвращаем итоговый объект для дальнейшей рассылки клиентам
...
// Экземпляр модели как синглтон, чтобы его переиспользовать по всем приложении
